...
function __autoload($class_name)
     ...
     session_monitor($_SESSION["USERTYPE"],"../","PHARMACY");
  ...
  <!--LEFT CONTENT -->
    ...
    <?php
      if(isset($_REQUEST["id"])||isset($_REQUEST["act"]))
          {
            echo'<div class="panel panel-default "><!--div class="panel-heading"><h3 class="panel-title">CONTENT</h3></div--><div class="panel-body">';
            ...
            if(isset($_REQUEST["act"])&& ($_REQUEST["auth"]==$_SESSION["un_id"]))
               {
